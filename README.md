...
part1
    ...
    - crate a NavBar.jsx seperate component file
...
Part2
    ...
    - wheneven you are making api call so pass axios => { withCredentials: true}
    - Install redux toolkit and react-redux
    - configureStore => add provider => create slice => add reducer
